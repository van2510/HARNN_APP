...
def parameter_parser():
    ...
    # Data Parameters
    parser.add_argument("--train-file", nargs="?", default="/Users/van.lambich/Desktop/HARNN_project-1/HARNN_app/models/data/Train_sample.json", help="Training data.")
    parser.add_argument("--validation-file", nargs="?", default="/Users/van.lambich/Desktop/HARNN_project-1/HARNN_app/models/data/Train_sample.json", help="Validation data.")
    parser.add_argument("--test-file", nargs="?", default="/Users/van.lambich/Desktop/HARNN_project-1/HARNN_app/models/data/Test_sample.json", help="Testing data.")
    parser.add_argument("--metadata-file", nargs="?", default="/Users/van.lambich/Desktop/HARNN_project-1/HARNN_app/models/data/metadata.tsv",
                        help="Metadata file for embedding visualization.")
    parser.add_argument("--word2vec-file", nargs="?", default="/Users/van.lambich/Desktop/HARNN_project-1/HARNN_app/models/data/vietnamese_word2vec.model",
                        help="Word2vec file for embedding characters (the dim need to be the same as embedding dim).")
    parser.add_argument("--fasttext-file", nargs="?", default="/Users/van.lambich/Desktop/HARNN_project-1/HARNN_app/models/data/fasttext.model",
                        help="Fasttext file for embedding characters (the dim need to be the same as embedding dim).")
    ...
    parser.add_argument("--num-classes-list", type=list, default=[13,66,78],
                        help="Each number of labels in hierarchical structure. (depends on the task)")
    parser.add_argument("--total-classes", type=int, default=157, help="Total number of labels. (depends on the task)")
