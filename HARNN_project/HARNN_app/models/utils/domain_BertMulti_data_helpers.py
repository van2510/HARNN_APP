...
def load_data_and_labels_domain(args, input_file, word2idx: dict):
    ...
    with open(input_file) as fin:
            ...
            for eachline in fin:
                ...
                labels = record['section']
                alllabels = record['labels']
                Data['id'].append(id)
                Data['content_index'].append(_token_to_index(content))
                Data['content'].append(content)
                Data['section1'].append(section)
                Data['subsection1'].append(subsection)
                Data['group1'].append(group)
                Data['all_labels'].append(list(alllabels))
                ...
                Data['onehot_labels'].append(_create_onehot_labels(labels, 13))
                Data['labels'].append(section)
...
def load_data_and_labels(args, input_file, word2idx: dict):
    ...
    def _token_to_index(token_list):
        result = []
