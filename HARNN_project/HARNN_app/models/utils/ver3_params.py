...
def parameter_parser():
    ...
    parser.add_argument("--num-classes-list", type=list, default=[13, 66],
                        help="Each number of labels in hierarchical structure. (depends on the task)")
    parser.add_argument("--total-classes", type=int, default=79, help="Total number of labels. (depends on the task)")
