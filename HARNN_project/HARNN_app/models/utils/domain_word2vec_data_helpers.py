...
# def fasttext_create_metadata_file(fasttext_file, output_file):
#     """
#     Create the metadata file based on the fasttext file (Used for the Embedding Visualization later).
...
#     word2idx = dict([(word, i) for i, word in enumerate(ft_model.get_words())])
